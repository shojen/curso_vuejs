...
<head>
	<meta charset="UTF-8">
	<title>Ejemplo 3 Vue.js - Mostrar y ocultar elementos v-if, v-else, v-show con vue.js 2</title>
			...
			<form v-on:submit.prevent="sumbitForm" action="#">
				...
				<template v-if="vue.exp">
					...
					-->
						...
						<p v-if="vue.descriptions==''" class="alert alert-danger">No has escrito nada</p>
					
					
						<p v-else-if="vue.descriptions.length<5" class="alert alert-warning">Has escrito menos de 5 letras</p>
					
					 
						<p v-else class="alert alert-success">Has escrito algo!!</p>
